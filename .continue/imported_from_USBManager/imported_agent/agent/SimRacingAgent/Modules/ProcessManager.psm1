...
Import-Module (Join-Path $PSScriptRoot "SoftwareManager.psm1") -ErrorAction SilentlyContinue

# Ensure global mock structures exist to avoid undefined-variable errors during tests
